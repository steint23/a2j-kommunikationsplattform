...
export function config(): Config {
  if (instance === undefined) {
    instance = {
      ...
      BRAK_IDP_OIDC_AUDIENCE: process.env.BRAK_IDP_OIDC_AUDIENCE?.trim() ?? "",
      ...
      BRAK_IDP_OIDC_REDIRECT_BASE:
        process.env.BRAK_IDP_OIDC_REDIRECT_BASE?.trim() ?? "",
    };
  }
